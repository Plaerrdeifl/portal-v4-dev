...
function renderAdminHome(){
  ...
  if(canRead("System"))portal.push(
    action("system","⚙️","Systemstatus","Zeigt Tabellenstatus und technische Hinweise."),
    action("audit","☷","Audit-Log","Zeigt nachvollziehbare Änderungen und Ereignisse."),
    action("performance","⏱️","Performance & Persistenz","Zeigt API-Laufzeiten und bestätigt gespeicherte Fachdatensätze.")
  );
