...
export function preloadAuthenticatedModules(keys = ["dashboard", "dates", "fanclub", "tasks", "teams", "liveticker", "admin"]) {
  const modules = {
    ...
    liveticker: "./modules/liveticker-admin.js?v=20260920-archive-endflyers-r1",
...
export async function hydratePage(key, context = {}) {
  ...
  if (key === "bus-orga") {
    ...
    if (view === "bookings") {
      return feature("./modules/bus-orga-bookings.js?v=20260919-fanbus-operator-append-r5&groups=20260919-operational-groups1&bookingux=20260920-r2a&travelgroups=20260920-r1a&addperson=20260924-mobile-r1&knownpeople=20260924-r2&appendfix=20260924-r1", "hydrateBusOrgaBookings", context);
    }
    if (view === "trip-edit") {
  ...
  if (key === "shop") return feature("./modules/shop.js?v=20260916-shop-area-r2", "hydrateShop", context);
  if (key === "shop-orders") return feature("./modules/shop-orders.js?v=20260916-shop-area-r2", "hydrateShopOrders", context);
  ...
  if (key === "liveticker") return feature("./modules/liveticker-admin.js?v=20260920-archive-endflyers-r1", "hydrateLivetickerAdmin", context);
