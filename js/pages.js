...
export function preloadAuthenticatedModules(keys = ["dashboard", "dates", "fanclub", "tasks", "teams", "liveticker", "admin"]) {
  const modules = {
    ...
    liveticker: "./modules/liveticker-admin.js?v=20260915-sticker-server-r1",
...
export async function hydratePage(key, context = {}) {
  ...
  if (key === "liveticker") return feature("./modules/liveticker-admin.js?v=20260915-sticker-server-r1", "hydrateLivetickerAdmin", context);
