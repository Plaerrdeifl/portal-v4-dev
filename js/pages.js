...
export async function hydratePage(key, context = {}) {
  ...
  if (key === "bus-orga") {
    ...
    if (view === "bookings") {
      return feature("./modules/bus-orga-bookings.js?v=20260919-fanbus-operator-append-r5&groups=20260919-operational-groups1&bookingux=20260920-r2a&travelgroups=20260920-r1a", "hydrateBusOrgaBookings", context);
    }
    if (view === "trip-edit") {
