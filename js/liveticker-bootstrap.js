...
await import("./liveticker-output-templates.js?v=20260906-r1");

const STORAGE_KEY = "plaerrdeifl.livetickerPrototype.v3";
const { prepareLivetickerGameStorage } = await import("./liveticker-game-storage.js?v=20260906-templates1");
