function injectStyles() {
  ...
  style.textContent = `
    ...
    .v4-m310-editor-fields>label:has(>input:is([type="date"],[type="time"],[type="datetime-local"])),.v4-m310-trip-stop-editor-row>label:has(>input[type="time"]){contain:inline-size;overflow:hidden}
