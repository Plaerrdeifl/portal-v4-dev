...
required=[
  ...
  "js/app.js","js/api.js","js/auth.js","js/google-identity.js","js/pages.js","js/router.js","js/ui.js",
  "js/modules/dashboard.js","js/modules/fanclub.js","js/modules/teams.js","js/modules/board.js","js/modules/fanbus.js","js/modules/admin.js",
...
add("Öffentliche Landingpage",'id="publicLoginButton"' in home and 'id="publicAboutText"' in home)
...
for route in ["dashboard","fanclub","cash","teams","board","fanbus","admin"]: add("Route "+route,re.search(rf'\b{route}\s*:',router) is not None)
sw=(root/"service-worker.js").read_text(encoding="utf-8")
for name in required:
  if name.startswith(("js/","pages/")): add("Service-Worker "+name,("./"+name) in sw)
