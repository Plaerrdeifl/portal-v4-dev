...
test("mobile portal round one follows the approved layout rules", async () => {
  ...
  assert.equal(css.includes(".sidebar .nav-footer{flex:0 0 auto;overflow:visible"), true);
  ...
  assert.equal(worker.includes("pd-portal-v4-ui-foundation-p1-acceptance-20260722-1"), true);
});
