...
test("cache busting identifies final opaque mobile shell", async () => {
  ...
  assert.match(index, /20260802-pwa-install-guidance-r1/);
  assert.match(config, /20260802-pwa-install-guidance-r1/);
