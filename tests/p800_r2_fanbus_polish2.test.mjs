...
test("Polish 2 keeps normal page scrolling while compacting the mobile trip stop editor", () => {
  ...
  assert.match(ux, /@media \(max-width:620px\)[\s\S]*\.v4-m310-editor-fields\{grid-template-columns:repeat\(2,minmax\(0,1fr\)\);column-gap:8px\}[\s\S]*\.v4-m310-trip-stop-editor-row\{grid-template-columns:112px minmax\(0,1fr\)\}[\s\S]*\.v4-m310-trip-stop-remove\{grid-column:1\/-1;justify-self:end\}/);
