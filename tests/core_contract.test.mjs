...
test("database migrations are ordered and contain the core contract", async () => {
  ...
  assert.deepEqual(names, [
    ...
    "20260906131925_add_fanbus_publishing_foundation_m340.sql",
    "20260906163500_liveticker_context_titles_prod_hotfix.sql",
    "20260906182716_add_fanbus_publishing_queue_m340.sql",
    ...
    "20260910095000_liveticker_template_upload_1mib.sql",
    ...
    "20260916064314_liveticker_whatsapp_delivery_components_dev_r1.sql",
    "20260916141500_shop_identity_r1.sql",
    "20260916182500_shop_admin_override_r1.sql",
    "20260917062900_liveticker_whatsapp_delivery_retry_dev_r1.sql",
    "20260917173757_liveticker_whatsapp_game_situation_stickers_dev_r1.sql",
    "20260917192915_liveticker_whatsapp_runtime_controls_dev_r1.sql",
    "20260917203046_liveticker_stale_revision_conflict_hotfix_dev_r1.sql",
    ...
    "20260919212559_restore_fanbus_operator_append_contract.sql",
    "20260919220959_fanbus_booking_primary_and_compact_ui.sql",
    "20260919231602_fanbus_travel_groups_r1.sql",
    ...
    "20260924161551_fanbus_booking_append_and_identity_filter_fix.sql",
    "20260925055302_liveticker_workers_realtime_wake_r1.sql"
  ]);
