...
$script:ProcessTargetRegistry = @(
    [pscustomobject][ordered]@{ targetId = 'npm.test'; targetKind = 'npm-script'; allowedStages = @('LocalVerify', 'LocalFreeze'); allowedTimeoutProfiles = @('standard', 'long'); defaultTimeoutProfile = 'standard'; startTimeoutSeconds = 15; workingDirectoryKind = 'repository-root'; healthCheck = $null },
    [pscustomobject][ordered]@{ targetId = 'npm.check-frontend'; targetKind = 'npm-script'; allowedStages = @('LocalVerify', 'LocalFreeze'); allowedTimeoutProfiles = @('standard', 'long'); defaultTimeoutProfile = 'standard'; startTimeoutSeconds = 15; workingDirectoryKind = 'repository-root'; healthCheck = $null },
    [pscustomobject][ordered]@{ targetId = 'npm.check-static'; targetKind = 'npm-script'; allowedStages = @('LocalVerify', 'LocalFreeze'); allowedTimeoutProfiles = @('standard', 'long'); defaultTimeoutProfile = 'standard'; startTimeoutSeconds = 15; workingDirectoryKind = 'repository-root'; healthCheck = $null },
    [pscustomobject][ordered]@{ targetId = 'npm.build'; targetKind = 'npm-script'; allowedStages = @('LocalVerify', 'LocalFreeze'); allowedTimeoutProfiles = @('long'); defaultTimeoutProfile = 'long'; startTimeoutSeconds = 15; workingDirectoryKind = 'repository-root'; healthCheck = $null },
    [pscustomobject][ordered]@{ targetId = 'fixture.exit-success'; targetKind = 'fixture'; allowedStages = @('SelfTest'); allowedTimeoutProfiles = @('short'); defaultTimeoutProfile = 'short'; startTimeoutSeconds = 10; workingDirectoryKind = 'fixture-root'; healthCheck = $null },
    [pscustomobject][ordered]@{ targetId = 'fixture.stderr-success'; targetKind = 'fixture'; allowedStages = @('SelfTest'); allowedTimeoutProfiles = @('short'); defaultTimeoutProfile = 'short'; startTimeoutSeconds = 10; workingDirectoryKind = 'fixture-root'; healthCheck = $null },
    [pscustomobject][ordered]@{ targetId = 'fixture.exit-failure'; targetKind = 'fixture'; allowedStages = @('SelfTest'); allowedTimeoutProfiles = @('short'); defaultTimeoutProfile = 'short'; startTimeoutSeconds = 10; workingDirectoryKind = 'fixture-root'; healthCheck = $null },
    [pscustomobject][ordered]@{ targetId = 'fixture.health-ready'; targetKind = 'fixture'; allowedStages = @('SelfTest'); allowedTimeoutProfiles = @('short'); defaultTimeoutProfile = 'short'; startTimeoutSeconds = 10; workingDirectoryKind = 'fixture-root'; healthCheck = (New-OperatorProcessHealthDefinition) },
    [pscustomobject][ordered]@{ targetId = 'fixture.health-failure'; targetKind = 'fixture'; allowedStages = @('SelfTest'); allowedTimeoutProfiles = @('short'); defaultTimeoutProfile = 'short'; startTimeoutSeconds = 10; workingDirectoryKind = 'fixture-root'; healthCheck = (New-OperatorProcessHealthDefinition) },
    [pscustomobject][ordered]@{ targetId = 'fixture.timeout'; targetKind = 'fixture'; allowedStages = @('SelfTest'); allowedTimeoutProfiles = @('short'); defaultTimeoutProfile = 'short'; startTimeoutSeconds = 10; workingDirectoryKind = 'fixture-root'; healthCheck = $null },
    [pscustomobject][ordered]@{ targetId = 'fixture.child-tree'; targetKind = 'fixture'; allowedStages = @('SelfTest'); allowedTimeoutProfiles = @('short'); defaultTimeoutProfile = 'short'; startTimeoutSeconds = 10; workingDirectoryKind = 'fixture-root'; healthCheck = $null },
    [pscustomobject][ordered]@{ targetId = 'fixture.secret-output'; targetKind = 'fixture'; allowedStages = @('SelfTest'); allowedTimeoutProfiles = @('short'); defaultTimeoutProfile = 'short'; startTimeoutSeconds = 10; workingDirectoryKind = 'fixture-root'; healthCheck = $null },
    [pscustomobject][ordered]@{ targetId = 'fixture.large-output'; targetKind = 'fixture'; allowedStages = @('SelfTest'); allowedTimeoutProfiles = @('standard'); defaultTimeoutProfile = 'standard'; startTimeoutSeconds = 10; workingDirectoryKind = 'fixture-root'; healthCheck = $null }
)
...
function Assert-OperatorProcessTargetRegistry {
    ...
    $expectedMatrix = @(
        [pscustomobject][ordered]@{ targetId = 'npm.test'; targetKind = 'npm-script'; allowedStages = @('LocalVerify', 'LocalFreeze'); allowedTimeoutProfiles = @('standard', 'long'); defaultTimeoutProfile = 'standard'; startTimeoutSeconds = [int]15; workingDirectoryKind = 'repository-root'; healthCheck = $null; scriptName = 'test'; fixtureMode = $null },
        [pscustomobject][ordered]@{ targetId = 'npm.check-frontend'; targetKind = 'npm-script'; allowedStages = @('LocalVerify', 'LocalFreeze'); allowedTimeoutProfiles = @('standard', 'long'); defaultTimeoutProfile = 'standard'; startTimeoutSeconds = [int]15; workingDirectoryKind = 'repository-root'; healthCheck = $null; scriptName = 'check:frontend'; fixtureMode = $null },
        [pscustomobject][ordered]@{ targetId = 'npm.check-static'; targetKind = 'npm-script'; allowedStages = @('LocalVerify', 'LocalFreeze'); allowedTimeoutProfiles = @('standard', 'long'); defaultTimeoutProfile = 'standard'; startTimeoutSeconds = [int]15; workingDirectoryKind = 'repository-root'; healthCheck = $null; scriptName = 'check:static'; fixtureMode = $null },
        [pscustomobject][ordered]@{ targetId = 'npm.build'; targetKind = 'npm-script'; allowedStages = @('LocalVerify', 'LocalFreeze'); allowedTimeoutProfiles = @('long'); defaultTimeoutProfile = 'long'; startTimeoutSeconds = [int]15; workingDirectoryKind = 'repository-root'; healthCheck = $null; scriptName = 'build'; fixtureMode = $null },
        [pscustomobject][ordered]@{ targetId = 'fixture.exit-success'; targetKind = 'fixture'; allowedStages = @('SelfTest'); allowedTimeoutProfiles = @('short'); defaultTimeoutProfile = 'short'; startTimeoutSeconds = [int]10; workingDirectoryKind = 'fixture-root'; healthCheck = $null; scriptName = $null; fixtureMode = 'exit-success' },
        [pscustomobject][ordered]@{ targetId = 'fixture.stderr-success'; targetKind = 'fixture'; allowedStages = @('SelfTest'); allowedTimeoutProfiles = @('short'); defaultTimeoutProfile = 'short'; startTimeoutSeconds = [int]10; workingDirectoryKind = 'fixture-root'; healthCheck = $null; scriptName = $null; fixtureMode = 'stderr-success' },
        [pscustomobject][ordered]@{ targetId = 'fixture.exit-failure'; targetKind = 'fixture'; allowedStages = @('SelfTest'); allowedTimeoutProfiles = @('short'); defaultTimeoutProfile = 'short'; startTimeoutSeconds = [int]10; workingDirectoryKind = 'fixture-root'; healthCheck = $null; scriptName = $null; fixtureMode = 'exit-failure' },
        [pscustomobject][ordered]@{ targetId = 'fixture.health-ready'; targetKind = 'fixture'; allowedStages = @('SelfTest'); allowedTimeoutProfiles = @('short'); defaultTimeoutProfile = 'short'; startTimeoutSeconds = [int]10; workingDirectoryKind = 'fixture-root'; healthCheck = 'required'; scriptName = $null; fixtureMode = 'health-ready' },
        [pscustomobject][ordered]@{ targetId = 'fixture.health-failure'; targetKind = 'fixture'; allowedStages = @('SelfTest'); allowedTimeoutProfiles = @('short'); defaultTimeoutProfile = 'short'; startTimeoutSeconds = [int]10; workingDirectoryKind = 'fixture-root'; healthCheck = 'required'; scriptName = $null; fixtureMode = 'health-failure' },
        [pscustomobject][ordered]@{ targetId = 'fixture.timeout'; targetKind = 'fixture'; allowedStages = @('SelfTest'); allowedTimeoutProfiles = @('short'); defaultTimeoutProfile = 'short'; startTimeoutSeconds = [int]10; workingDirectoryKind = 'fixture-root'; healthCheck = $null; scriptName = $null; fixtureMode = 'timeout' },
        [pscustomobject][ordered]@{ targetId = 'fixture.child-tree'; targetKind = 'fixture'; allowedStages = @('SelfTest'); allowedTimeoutProfiles = @('short'); defaultTimeoutProfile = 'short'; startTimeoutSeconds = [int]10; workingDirectoryKind = 'fixture-root'; healthCheck = $null; scriptName = $null; fixtureMode = 'child-tree' },
        [pscustomobject][ordered]@{ targetId = 'fixture.secret-output'; targetKind = 'fixture'; allowedStages = @('SelfTest'); allowedTimeoutProfiles = @('short'); defaultTimeoutProfile = 'short'; startTimeoutSeconds = [int]10; workingDirectoryKind = 'fixture-root'; healthCheck = $null; scriptName = $null; fixtureMode = 'secret-output' },
        [pscustomobject][ordered]@{ targetId = 'fixture.large-output'; targetKind = 'fixture'; allowedStages = @('SelfTest'); allowedTimeoutProfiles = @('standard'); defaultTimeoutProfile = 'standard'; startTimeoutSeconds = [int]10; workingDirectoryKind = 'fixture-root'; healthCheck = $null; scriptName = $null; fixtureMode = 'large-output' }
    )
    $seen = @{}
    for ($registryIndex = 0; $registryIndex -lt $expectedMatrix.Count; $registryIndex++) {
        ...
        $expected = @('targetId', 'targetKind', 'allowedStages', 'allowedTimeoutProfiles', 'defaultTimeoutProfile', 'startTimeoutSeconds', 'workingDirectoryKind', 'healthCheck')
        ...
        foreach ($stringProperty in @('targetId', 'targetKind', 'defaultTimeoutProfile', 'workingDirectoryKind')) { if ($registration.$stringProperty -isnot [string] -or [string]$registration.$stringProperty -cne [string]$expectedRegistration.$stringProperty) { throw 'Trusted process target registry is invalid.' } }
