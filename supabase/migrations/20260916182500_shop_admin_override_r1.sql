-- Plärrdeifl Portal V4 / Shop admin override R1
-- Keeps commerce customer class separate from authorization.
-- Portal admins may access the shop without being reclassified as members.
